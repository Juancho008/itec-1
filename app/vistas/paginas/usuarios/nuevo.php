...
<main id="container">
	...
	<?php
		...
		$onblur = ' onblur="buscarUsuario(this.value)" ';
		$readonly = '';
		$dato['id'] = '';
		$dato['id_perfil'] = '';
		$dato['usuario'] = '';
	...
	<hr>
	<form action="<?php echo RUTA_URL . '/Usuarios/guardar' ?>" id="formulario" method="post">
		<input type="hidden" name="id" value="<?php echo $dato['id'] ?>">
		<div class="row">
			<div class="col-12 col-md-6 col-lg-6">
				<div class="row">
					<div class="col-12 form-group">
						<label for="perfil">Perfil de Usuario <strong>*</strong></label>
				...
				<div class="row">
					<div class="col-12 form-group">
						<label for="usuario">Nombre de Usuario <strong>*</strong></label>
						<input id="usuario" 
							type="text" 
							name="usuario" 
							...
							class="form-control" 
							autocomplete="off" 
							onkeyup="buscarUsuario2('usuario',this.value)"
							required="true" <?php echo $readonly . ' ' /* . $onblur */ ?>>
					</div>
				</div>
				<?php if ($dato['id'] == '') { ?>
					<div class="row">
						<div class="col-12 form-group">
							<label for="clave">Clave <strong>*</strong></label>
							<input id="clave" type="password" class="form-control" name="clave" autocomplete="off" required="true">
						</div>
					</div>
					<div class="row">
						<div class="col-12 form-group">
							<label for="clave2">Repetir Clave <strong>*</strong></label>
					...
					<div class="col-12 form-group">
						...
						<select name="id_municipio" class="form-control">
							...
							foreach ($datos['municipios'] as $muni) {
								echo "<option value='{$muni['id_municipio']}' ".($muni['id_municipio']==$dato['id_municipio']?'selected':'')." >" . $muni['nombre'] . "</option>";
							}
							?>
						</select>
					</div>
				...
				<div class="row">
					<div class="col-12 form-group">
						...
						<input id="documento" 
							...
							onkeyup="buscarUsuario2('documento',this.value)"
							autocomplete="off">
					</div>
				</div>
				<div class="row">
	...
	<script type="text/javascript">
		...
		function buscarUsuario(usuario) {
			...
			$.ajax({
				data: parametros,
				url: '<?php echo RUTA_URL ?>/ajax/existeUsuario',
				type: 'post',
				beforeSend: function() {
					$('#loader').show();
				},
		...
		function buscarUsuario2(campo, dato) {
			let input = null;
			let span = null;
			$.post({
